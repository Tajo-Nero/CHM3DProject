...
//    private List<Rigidbody> affectedRigidbodies = new List<Rigidbody>(); // 영향을 받는 Rigidbody 목록
//    private Dictionary<Rigidbody, Vector3> originalPositions = new Dictionary<Rigidbody, Vector3>(); // 원래 위치 저장
//    private Dictionary<Rigidbody, Quaternion> originalRotations = new Dictionary<Rigidbody, Quaternion>(); // 원래 회전 저장
...
//            Debug.Log("탑 감지됨: " + towerColliders.Length + "개");
...
//                        Debug.Log("탑 이동 중: " + rb.gameObject.name);
//                    }
//                    else
//                    {
//                        rb.transform.position = targetPosition;
//                        Debug.Log("탑 이동 완료: " + rb.gameObject.name);
//                    }
//                }
//            }
//        }
...
//                Debug.Log("중력 적용됨: " + rb.gameObject.name);
//                affectedRigidbodies.Add(rb); // 영향을 받는 Rigidbody 목록에 추가
//            }
//        }
//    }
...
//                        Debug.Log("원래 위치와 회전으로 되돌림: " + rb.gameObject.name);
//                    }
//                }
//            }
//        }
